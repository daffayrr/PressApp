...
$pageTitle = "Data Pengajuan Lembur";
...
// Query diubah untuk mengambil tipe_pengajuan = 'lembur'
$sql = "SELECT p.id, p.tanggal_mulai, p.keterangan, p.bukti, p.status_pengajuan, k.nama_lengkap, k.jabatan, k.role
        FROM pengajuan p
...
<main class="main-content">
    <div class="content-panel">
        <h1 style="font-size: 1.5rem; font-weight: 700; color: #0d6efd; margin-bottom: 0.5rem;">Dashboard - Data Pengajuan Lembur</h1>
        <hr style="margin-bottom: 1.5rem;">

        <!-- Form Filter Status -->
        <div style="background-color: #f8f9fa; padding: 1rem; border-radius: 6px; margin-bottom: 1.5rem; border: 1px solid #dee2e6;">
            <form action="data_lembur.php" method="GET" style="display: flex; align-items: center; gap: 1rem;">
                <div>
            ...
            <table style="width: 100%; border-collapse: collapse; text-align: left;">
                <thead style="background-color: #343a40; color: white;">
                    <tr>
                        ...
                        <th style="padding: 12px 15px;">Tanggal Lembur</th>
                ...
                <tbody>
                    <?php if ($result->num_rows > 0): $no = 1; ?>
                        ...
                        <tr style="border-bottom: 1px solid #dee2e6;">
                            ...
                            <td style="padding: 12px 15px;"><?php echo date('d M Y', strtotime($row['tanggal_mulai'])); ?></td>
                        ...
                        <?php endwhile; ?>
                    <?php else: ?>
                        <tr><td colspan="7" style="padding: 12px 15px; text-align: center; color: #6c757d;">Tidak ada data pengajuan lembur.</td></tr>
                    <?php endif; ?>
                </tbody>
            </table>
        </div>
